...
namespace ExtendedControls.Controls.AstroPlotPrevious
{
    internal static class Update
    {
        internal static void PlotObjects(List<ExtAstroPlotPrevious.PlotObjects> mapSystems, int x, int y, double z, double[] cameraPosition, double azimuth, double elevation)
        {
        ...
        internal static void AxesWidget(List<ExtAstroPlotPrevious.Axis> widgets, int x, int y, double z, double[] cameraPosition, double azimuth, double elevation)
        {
            var _interaction = Interaction(azimuth, elevation, cameraPosition);
            var _data = Coords(x, y, z);
            var X_h = new Matrices<double>(4, 1);
        ...
        internal static void FrameWidget(List<ExtAstroPlotPrevious.Corner> frames, int x, int y, double z, double[] cameraPosition, double azimuth, double elevation)
        {
            var _interaction = Interaction(azimuth, elevation, cameraPosition);
            var _data = Coords(x, y, z);
            var X_h = new Matrices<double>(4, 1);
