    ...
    public class ThemeList
    {
        ...
        public void LoadBaseThemes()                                    // base themes load
        {
            ...
            themelist.Add(new Theme("Orange Delight", Color.Black,
                Color.FromArgb(255, 48, 48, 48), Color.Orange, Color.DarkOrange, Theme.buttonstyle_gradient, // button
                ...
                Color.Black, Color.Orange, Color.Red, Color.Green, Color.DarkOrange, Theme.textboxborderstyle_color, // text box
            ...
            if (IsFontAvailable("Euro Caps"))
            {
                ...
                themelist.Add(new Theme("Elite EuroCaps Less Border", Color.Black,
                    Color.FromArgb(255, 64, 64, 64), Color.Orange, Color.FromArgb(255, 96, 96, 96), Theme.buttonstyle_gradient, // button
                    Color.FromArgb(255, 176, 115, 0), Color.Black,  // grid border
                    ...
                    Color.Red, Color.White, // travel
                    butback, Color.Orange, Color.Red, Color.Green, Color.FromArgb(255, 64, 64, 64), Theme.textboxborderstyle_color, // text box
            ...
            themelist.Add(new Theme("Easy Dark", Color.FromArgb(255, 65, 65, 65), // form
                Color.FromArgb(255, 75, 75, 75), Color.FromArgb(255, 245, 120, 30), Color.FromArgb(255, 41, 46, 51), Theme.buttonstyle_flat, // button back, text, border
                ...
                Color.FromArgb(255, 28, 30, 34), Color.FromArgb(255, 240, 240, 240), Color.FromArgb(255, 248, 148, 6), Color.FromArgb(255, 90, 196, 90), Color.FromArgb(255, 46, 51, 56), Theme.textboxborderstyle_color, // textbox back, fore, highlight, success, border
            ...
            themelist.Add(new Theme("EDSM", Color.FromArgb(255, 39, 43, 48), // form
                Color.FromArgb(255, 71, 77, 84), Color.FromArgb(255, 245, 245, 245), Color.FromArgb(255, 41, 46, 51), Theme.buttonstyle_flat, // button back, text, border
                ...
                Color.FromArgb(255, 28, 30, 34), Color.FromArgb(255, 200, 200, 200), Color.FromArgb(255, 248, 148, 6), Color.FromArgb(255, 90, 196, 90), Color.FromArgb(255, 46, 51, 56), Theme.textboxborderstyle_color, // textbox back, fore, highlight, success, border
            ...
            themelist.Add(new Theme("Material Dark", Color.FromArgb(255, 54, 57, 63), // form
                Color.FromArgb(255, 75, 75, 75), Color.FromArgb(255, 255, 160, 0), Color.FromArgb(255, 41, 46, 51), Theme.buttonstyle_flat, // button back, text, border
                ...
                Color.FromArgb(255, 192, 0 , 0), Color.FromArgb(255, 202, 202, 255), // travelgrid_nonvisited, visited
                Color.FromArgb(255, 47, 49, 54), Color.FromArgb(255, 240, 240, 240), Color.FromArgb(255, 255, 160, 0), Color.FromArgb(255, 90, 196, 90), Color.FromArgb(255, 82, 94, 164), Theme.textboxborderstyle_color, // textbox back, fore, highlight, success, border
            ...
            themelist.Add(new Theme("Night Vision", Color.Black,
                Color.FromArgb(255, 48, 48, 48), r1, r2, Theme.buttonstyle_gradient, // button
                ...
                Color.Black, r1, Color.Orange, Color.Green, r2, Theme.textboxborderstyle_color, // text box
            ...
            if (IsFontAvailable("Euro Caps"))
            {
                themelist.Add(new Theme("EuroCaps Grey",
                                        SystemColors.Menu,
                                        SystemColors.Control, SystemColors.ControlText, Color.DarkGray, Theme.buttonstyle_gradient,// button
                                        ...
                                        SystemColors.Window, SystemColors.WindowText, Color.Red, Color.Green, Color.DarkGray, Theme.textboxborderstyle_color,// text
            ...
            themelist.Add(new Theme("Blue Wonder", Color.DarkBlue,
                                               Color.Blue, Color.White, Color.White, Theme.buttonstyle_gradient,// button
                                               ...
                                               Color.DarkBlue, Color.White, Color.Red, Color.Green, Color.White, Theme.textboxborderstyle_color,// text box
            ...
            themelist.Add(new Theme("Green Baize", baizegreen,
                                               baizegreen, Color.White, Color.White, Theme.buttonstyle_gradient,// button
                                               ...
                                               baizegreen, Color.White, Color.Red, Color.Green, Color.White, Theme.textboxborderstyle_color,// text box
            ...
            {                                                                               // exported via theme load in EDDiscovery
                themelist.Add(new Theme("Deep Blue Sky",
                            ...
                            Theme.textboxborderstyle_color,
        ...
        public bool Load(string path, string filewildcard)
        {
            try
            {
                ...
                {
                    Theme set = new Theme();
                    if ( set.LoadFile(fi.FullName, Path.GetFileNameWithoutExtension(fi.Name)))
                    { 
                        themelist.Add(set);
                    }
                }
