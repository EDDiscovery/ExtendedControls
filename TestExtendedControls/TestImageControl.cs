...
namespace TestExtendedControls
{
    public partial class TestImageControl : Form
    {
        ...
        {
            base.OnShown(e);
            imageControl1.DrawText(new Rectangle(10, vpos, 30000, 30000), "First message", tf, Color.Yellow, null);
            vpos += 30;
            imageControl1.DrawText(new Point(10,50), new Size(30000,30000), "Second message", tf, Color.Yellow, Color.Red);
            vpos += 30;
