...
namespace DialogTest
{
    public partial class TestAstroPlot : Form
    {
        ...
        {
            localSystemsList.Add(new LocalSystems { Name = "Synuefe VR-E c27-6", X = 874.59, Y = -475.22, Z = 119.25, IsVisited = true, IsCurrent = true });
            ...
            localSystemsList.Add(new LocalSystems { Name = "Synuefe RZ-H b55-0", X = 876.50, Y = -464.50, Z = 117.53, IsVisited = true });
            localSystemsList.Add(new LocalSystems { Name = "Synuefe RZ-H b55-0", X = 869.28, Y = -474.44, Z = 111.72, IsVisited = true });
            ...
            localSystemsList.Add(new LocalSystems { Name = "Synuefe ZX-C c28-8", X = 873.53, Y = -485.00, Z = 139.53, IsVisited = true });
            ...
            localSystemsList.Add(new LocalSystems { Name = "Synuefe ZL-B d14-21", X = 873.78, Y = -483.63, Z = 143.13, IsVisited = true });
            ...
            localSystemsList.Add(new LocalSystems { Name = "Synuefe SZ-H b55-0", X = 900.06, Y = -464.44, Z = 115.22, IsVisited = true });
        ...
        public void DrawLocalSystems()
        {
            ...
            {
                Stars.Add(new object[] { localSystemsList[i].Name, localSystemsList[i].X, localSystemsList[i].Y, localSystemsList[i].Z, localSystemsList[i].IsVisited, false, localSystemsList[i].IsCurrent });
            }
            extAstroPlotTest.AddSystemsToMap(Stars);
        }
        ...
        public void DrawTravelMap()
        {
            ...
            {
                Travel.Add(new object[] { travelSystemsList[i].Name, travelSystemsList[i].X, travelSystemsList[i].Y, travelSystemsList[i].Z, true, true, travelSystemsList[i].IsCurrent });
            }
            extAstroPlotTest.AddSystemsToMap(Travel);
        }
